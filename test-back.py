...
VSD
"""
re_Find_VSD = re.compile(u"([A][T][V][\w]{5,})[ ].*[ ]([\d]{0,}[,][\d]{3}|[\d]{1,3})[ ]")
"""
MAC01
"""
...
C65
"""
re_Find_C65 = re.compile(r"([A-Z0-9]{6,})[ ].*[ ]([\d]{1,}[.][\d]{1}[\s])")
...
j 'VSD_Price':[re_Find_VSD], 'MAC01_Price':[re_Find_MAC01], 'LECA_Price':[re_Find_LECA],\
